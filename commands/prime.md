---
description: Session initialization. Syncs Notion databases to local markdown cache and presents a briefing. Triggered by /prime.
---
...
```bash
python commands/sync_notion_cache.py --output-dir Context/notion-cache/
```
