...
description: An advanced setup skill that builds a complete construction company "second brain" in Notion, including SOPs, cost history, and lessons learned. Triggered by /ailtir-notion-second-brain.
---
...
## Step 5 — Output
Confirm the setup is complete. Explain that the `/prime` command will now sync this expanded knowledge base into the local `Context/notion-cache/` folder for Ailtir to use in future sessions.
