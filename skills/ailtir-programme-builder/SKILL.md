...
CWMF tenders require a written narrative explaining the programme. Draft a 1-page document covering:
...
- DO NOT use US date formats (MM/DD/YYYY). Always use Irish format (DD/MM/YYYY).
...
- [ ] Irish date format used (DD/MM/YYYY) throughout.
