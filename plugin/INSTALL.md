...
|---|---|---|
| `ailtir` | `https://mcp.62.238.51.124.sslip.io/ailtir-mcp` | None for public anonymous usage and feedback tools |
...
The Ailtir server is a public remote connector and does not receive an MCP
token. Configure optional Notion and Microsoft 365 credentials using your
normal secure settings or connector flow. Do not commit secrets.
