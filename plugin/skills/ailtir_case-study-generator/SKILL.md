...
description: Converts completed project data into structured case studies, and processes tender debriefs to extract learning signals. Triggered by /ailtir_case-study-generator or debrief mode.
---
