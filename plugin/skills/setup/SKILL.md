...
Read `templates/CLAUDE.md` from this skill's directory. Replace the placeholders (`{{COMPANY_NAME}}`, `{{LOCATION}}`, `{{SECTORS}}`, `{{ACCREDITATIONS}}`, `{{DATE}}`) with the data gathered in the interview.
